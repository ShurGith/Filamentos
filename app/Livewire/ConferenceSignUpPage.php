            ...
            ->form([
                Placeholder::make('total_price')
                    ...
                    ->content(function (Get $get) {
                        return new HtmlString('<div class="inline-flex"><p class="text-lg font-bold">Total Price: $</p><p class="text-lg font-bold text-red-500">' . count($get('attendees')) * 500 . '</p></div>');
